...
namespace SimpleFolderIcon.Editor
{
    ...
    {
        private const string AssetsPath = "Plugins/Icons";
        ...
        internal static void BuildDictionary()
        {
            ...
            {
                var texture = (Texture)AssetDatabase.LoadAssetAtPath($"Assets/Plugins/Icons/{f.Name}", typeof(Texture2D));
            ...
            {
                var folderIconSO = (FolderIconSO)AssetDatabase.LoadAssetAtPath($"Assets/Plugins/Icons/{f.Name}", typeof(FolderIconSO));
